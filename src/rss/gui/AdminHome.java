...
public class AdminHome extends javax.swing.JFrame {
    ...
    private void btnAddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAddMouseClicked
        ...
        }else
        {
            ...
            if(a.addAdmin.apply(userName).apply(password).apply(email).apply(phone))
            {
    ...
    private void btnDeleteProductMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDeleteProductMouseClicked
        ...
        {
            a.deleteProduct.apply(pd.p.getId());
            f.updateTable(tbProduct,pd.getProductList());
        }
    ...
    private void btnUpdateProductMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUpdateProductMouseClicked
        ...
        if (!a.updateProduct.apply(pd.p.getId()).apply(name).apply(desc).apply(pd.p.getFragile()).apply(quantity).apply(price))
        {
    ...
    private void btnNewProductMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnNewProductMouseClicked
         ...
         }else
        {
            ...
            if(a.addProduct.apply(Name).apply(Description).apply(fragile).apply(quantity).apply(price))
            {
                JOptionPane.showMessageDialog(null,"Register Sccessful","Successful", 1);
                f.updateTable(tbProduct, pd.getProductList());
                txtPName.setText("");
    ...
    private void btnDelCustMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDelCustMouseClicked
        ...
        if (response == JOptionPane.YES_OPTION)
        {
            a.deleteUser.apply(ud.c.getUsername()).apply(ud.c.getaccountType());
            f.updateCustTable(tbOrder,od.getOrderList());
        }
    ...
    private void btnUpdateCustMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUpdateCustMouseClicked
        ...
        if (!a.updateCustomer.apply(ud.c.getUsername()).apply(pass).apply(email).apply(Integer.parseInt(phone)))
        {
            JOptionPane.showMessageDialog(null,"Update Fail, Please try again !","Fail", 3);
        }else
        {
